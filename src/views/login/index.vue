<template>
  <div class="login-container">
    ...
    <div class=" flex-x-end p-15 w-full">
      <!-- 登录表单 -->
    ...
    <div class="absolute bottom-1 text-[10px] text-center" v-show="icpVisible">
      <p>
        Copyright © 2021 - 2024 EasyMap All Rights Reserved. EasyMap技术版权所有  京ICP备17034476号-1
      </p>
    </div>
  </div>
</template>
...
html.dark .login-container {
  background: url("@/assets/images/login-bg-dark.jpg") no-repeat left;
}
